...
import 'package:bookpad/views/home/widgets/profile_drawer.dart';
          ...
          child: Column(
            children: [
              StreamBuilder<List<StoryModel>> (
                stream: storyService.getAdminStories(),
                    ...
                    itemCount: stories.length,
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                          ...
                          child: StoryCard(title: data.title, summary: data.summary, date: data.createdAt, color: Colors.lightGreen),
                        );
                      }
                  );
                },
